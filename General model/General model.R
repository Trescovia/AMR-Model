...
scenario_income <- "LIC" #must be "LIC", "MIC", or "HIC"
...
##Intervention - Chickens - Industrial
  ...
  r_sold_c_i2 <- r_sold_c_i * (1+inputs[parameter == "chicken_income_effect", Value])
...
##Intervention - Chickens - Smallholder
  ...
  r_sold_c_s2 <- r_sold_c_s * (1+inputs[parameter == "chicken_income_effect", Value])
...
##Intervention - Pigs - Industrial
  ...
  r_sold_p_i2 <- r_sold_p_i * (1+inputs[parameter == "pig_income_effect", Value])
...
##Intervention - Pigs - Smallholder
  ...
  r_sold_p_s2 <- r_sold_p_s * (1+inputs[parameter == "pig_income_effect", Value])
...
#synthesise results into output matrix
